...
_DEPS=matrix.h piece.h tetris.h opengltetris.h cube.h DynamicPiece.h chardisplay.h worddisplay.h
DEPS=$(patsubst %,$(SRCDIR)/%,$(_DEPS))

_OBJ=main.o piece.o tetris.o opengltetris.o DynamicPiece.o chardisplay.o worddisplay.o
